...
import {
  Shield, AlertTriangle, Save, Sparkles, FileSearch, Lightbulb,
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        ...
        >
          ...
          <p className="text-text-secondary max-w-2xl mx-auto text-lg">
            Paste any job description – AI instantly checks for <span className="text-primary font-medium">payment fraud</span>, <span className="text-primary font-medium">fake companies</span>, <span className="text-primary font-medium">urgency traps</span>, and more. 
            Get a clear risk percentage and actionable advice.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            { icon: Sparkles, title: '2. AI Analyzes', desc: 'Scans for scams, fake payments, urgency tricks.' },
            { icon: Lightbulb, title: '3. Get Insights', desc: 'Risk %, red flags, and expert summary to decide.' },
          ].map((step, i) => (
            <div
              key={i}
              ...
              {result.redFlags?.length > 0 && (
                <div className="space-y-3">
                  ...
                  {result.redFlags.map((flag, idx) => (
                    <div
                      key={idx}
                      className="bg-red-900/10 border border-red-800 rounded-xl overflow-hidden"
                    >
                      <button
                      ...
                      {expandedFlags[idx] && (
                        <div className="p-4 border-t border-red-800 bg-black/50">
                          <p className="text-sm text-gray-400">This issue contributed to the risk score. Avoid jobs with such indicators.</p>
                        </div>
                      )}
                    </div>
                  ))}
